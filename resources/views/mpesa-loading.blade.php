...
<head>
    ...
    <script>
        ...
        function confirmDelete(reference) {
            return confirm('Are you sure you want to delete the transaction with reference "' + reference + '"?\n\nThis action cannot be undone.');
        }
        ...
        function confirmBulkDelete() {
            ...
            return confirm('Are you sure you want to delete ' + checkboxes.length + ' selected transaction(s)?\n\nThis action cannot be undone.');
        }

        // Select all functionality
        function toggleSelectAll() {
            const selectAllCheckbox = document.getElementById('select-all') || document.getElementById('select-all-header');
        ...
        function bulkDelete() {
            ...
            form.method = 'POST';
            form.action = '{{ route("mpesa.bulk-delete") }}';
